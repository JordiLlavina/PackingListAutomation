...
- Los tests instancian los servicios con `new` (JUnit 5 puro); solo `PackingListApplicationTest` levanta contexto Spring. Los tests de builders reabren el `.xlsx` generado con POI y comprueban celdas reales — seguir ese patrón.
